...
public class SocketController {
    ...
    public void doCompany(MessageDto messageDto, SimpMessageHeaderAccessor messageHeaderAccessor) throws Exception {
        ...
        // List<Subscribe> subscribes = (List<Subscribe>)
        // messageHeaderAccessor.getSessionAttributes().get("sessionList");
        // for(Subscribe subscribe : subscribes){
        // System.out.println(subscribe);
        // messageSendingOperations.convertAndSend("/sub/addRecruit/"+subscribe.getSubscribeUserId(),
        // messageDto);
        // }
